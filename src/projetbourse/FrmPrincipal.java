...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        //ajouter aux traders les actions
        ...
        //on ajoute les traders a la liste des traders 
    ...
    private void tblTradersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTradersMouseClicked
        ...
        String choix;
        choix = tblTraders.getValueAt(tblTraders.getSelectedRow(),1).toString();
        
        dtmActions.getDataVector().removeAllElements();
        
        for(Trader trad :mesTraders )
        {
           if(trad.getNomTrader().compareTo(choix)==0)
            {
               for (Action act : trad.getMesActions())
               {
                   portefeuille =(portefeuille) + (act.getValeurAction()*act.getQuantiteAcheter()) - (act.getPrixAchatAction()*act.getQuantiteAcheter());
                   v=new Vector();
                   v.add(act.getIdAction());
                   v.add(act.getNomAction());
                   v.add(act.getValeurAction());
                   v.add(act.getPrixAchatAction());
                   v.add(act.getQuantiteAcheter());
                   dtmActions.addRow(v);
                   lblPortefeuille.setText(String.valueOf(portefeuille));
               }
